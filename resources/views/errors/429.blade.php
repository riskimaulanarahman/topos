  ...
  <div class="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2">
    <div class="card card-primary">
      <div class="card-body text-center py-5">
        <div class="display-1 font-weight-bold mb-3">429</div>
        <h4 class="mb-3">Terlalu Banyak Permintaan</h4>
        <p class="text-muted mb-4">Anda mengirim terlalu banyak permintaan dalam waktu singkat. Silakan coba lagi nanti.</p>
        <div>
