...
@section('title', 'Create Discount Forms')
                        ...
                        <div class="card-body">
                                        ...
                                        <div class="selectgroup w-100">
                                            <label class="selectgroup-item">
                                                <input type="radio" name="type" value="percentage"
                                                    class="selectgroup-input" {{ old('type', 'percentage') === 'percentage' ? 'checked' : '' }}>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="scope" id="discount-scope-select"
                                            ...
                                            <option value="outlet" {{ old('scope') === 'outlet' ? 'selected' : '' }}>Outlet</option>
                                            <option value="product" {{ old('scope') === 'product' ? 'selected' : '' }}>Produk Tertentu</option>
                                        </select>
                                        @error('scope')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-muted">Semakin tinggi prioritas, diskon akan diterapkan lebih dulu.</small>
                                        @error('priority')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="autoApplyCheck"
                                        name="auto_apply" value="1" {{ old('auto_apply') ? 'checked' : '' }}>
                            ...
                            <div class="form-group" id="discount-product-field" style="display: none;">
                                ...
                                <select name="product_ids[]" id="discount-product-select"
                                    ...
                                    multiple data-placeholder="Pilih produk" data-width="100%" data-ajax-url="{{ route('discount.products.search') }}"
